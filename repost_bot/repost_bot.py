...
class repost_bot:
    def __init__(self):
        ...
        #shame
        self.shame_file = os.path.join(self.storage_path, "shame.json")
        self.shame_entries = self.open_storage(self.shame_file)
        #average_hashes
    ...
    def shame_dump(self, username, user_dict, chat_dict, date, update_id, message_id, response):
        shame = {
            "username":username,
        ...
        with open(self.shame_file, 'w') as storage_file:
            json.dump(shame, storage_file, indent = 2)
